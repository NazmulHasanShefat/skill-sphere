      ...
      <div className="hero_cart grid grid-cols-12 md:pt-20">
        <div className="left lg:col-span-8 md:col-span-6 col-span-12 pl-5">
          <motion.h1
            ...
            className="md:text-5xl text-3xl font-bold py-5 text-white md:leading-15"
          >
          ...
          <div className="out-features flex-wrap py-3 flex gap-3 w-full">
            ...
            <span className="flex w-max items-center gap-2 bg-linear-to-r from-blue-950 to-blue-800 ring-1 text-xs text-blue-200 font-light ring-blue-500 py-1 px-2 rounded-md">
              {" "}
              <div className="w-[10px] h-[10px] bg-blue-500"></div> Marketing
            </span>
            <span className="flex items-center w-max gap-2 bg-linear-to-r from-blue-950 to-blue-800 ring-1 text-xs text-yellow-500 font-light ring-blue-500 py-1 px-2 rounded-md">
              {" "}
              <div className="w-[10px] h-[10px] bg-yellow-500"></div> Marketing
            </span>
          </div>
